...
/*   Updated: 2024/10/12 14:15:51 by khmessah         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	info->texture[0].xpm_ptr = mlx_xpm_file_to_image(info->mlx, "walls_textures/mur_1.xpm", &info->texture[0].w, &info->texture[0].h);
	...
	info->texture[1].xpm_ptr = mlx_xpm_file_to_image(info->mlx, "walls_textures/mur_2.xpm", &info->texture[1].w, &info->texture[1].h);
	...
	info->texture[2].xpm_ptr = mlx_xpm_file_to_image(info->mlx, "walls_textures/ps3.xpm", &info->texture[2].w, &info->texture[2].h);
	...
	info->texture[3].xpm_ptr = mlx_xpm_file_to_image(info->mlx, "walls_textures/prison_lux1.xpm", &info->texture[3].w, &info->texture[3].h);
	info->texture[3].image = mlx_get_data_addr(info->texture[3].xpm_ptr, &info->texture[3].bet_pxl, &info->texture[3].size_line, &info->texture[3].endn);
													...
													/*    bunus      */
	info->texture[4].xpm_ptr = mlx_xpm_file_to_image(info->mlx, "bonus_textures/port_f.xpm", &info->texture[4].w, &info->texture[4].h);
	...
	info->texture[5].xpm_ptr = mlx_xpm_file_to_image(info->mlx, "bonus_textures/port_o.xpm", &info->texture[5].w, &info->texture[5].h);
